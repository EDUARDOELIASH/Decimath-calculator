...
public class JFrame_EN extends JFrame {
	int VAR,NR;
	 ...
	 * Create the frame.
	 */
	public JFrame_EN(int [][] Costos, final int [] oferta, final int [] demanda, final int Origenes, final int Destinos, final int totalO, final int totalD, final boolean oFicticio, final boolean dFicticio,final int caso) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(dato==true){			
					dispose();
					PrincipalEN AS=new PrincipalEN(costos,oferta,demanda,Origenes,Destinos,totalO,totalD,oFicticio,dFicticio);
					AS.main();
