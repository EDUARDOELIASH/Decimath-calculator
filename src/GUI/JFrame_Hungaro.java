...
public class JFrame_Hungaro extends JFrame {
	int VAR,NR;
	 ...
	 * Create the frame.
	 */
	public JFrame_Hungaro(int [][] Costos, final int Oferta, final int Demanda, int Origenes,int Destinos, final boolean destino, final boolean origen) {
		...
		JLabel Titulo = new JLabel("Metodo Hungaro");
		panel.add(Titulo);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(dato==true){					
					dispose();
					DatosHungaro AS=new DatosHungaro(costos,Oferta,Demanda,NR,VAR,destino, origen);
					AS.TablaParametrosH();
