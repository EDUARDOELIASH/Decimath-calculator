...
public class Datos2F {
    ...
    int[] holguras;
    char objetivo = ' ';
    int nholgurasB = 0, nholgurasNB = 0;
    
    public Datos2F(double vardecision[], char OBJETIVO, double restriccionI[][],String SimboloFN[],int Sigma,int NR,int VAR){
    ...
    /*public void leer(){
        ...
        while (nvarV == false){
            try{ //Manejo de excepciones
                excepcion = false;
                s.print("digite número de variables de decision: ");
                nvar = entrada.nextInt();
            }
            ...
            if (nvar >= 2){
                ...
                s.print("Numero de variables debe ser >= 2 porfavor, ");
            }     
        }
        s.println();
    ...
    public void varHolguras(){
        ...
        totalVar = nholgurasB + nholgurasNB + nvar;
        //System.out.println(totalVar);
    }
    ...
    public void tabla2F() {
    	boolean solucionB;
    	Tabla2F tabla = new Tabla2F(nrest, nvar, nholgurasB, nholgurasNB);
    	solucionB = tabla.solBasicaI(nrest, holguras);
    	tabla.matrizI(totalVar,vardecision, restriccionI, holguras, solucionB, nholgurasB, nholgurasNB);
 	tabla.resultado(totalVar, objetivo, nrest, nvar, solucionB, vardecision);	  
    }
}
