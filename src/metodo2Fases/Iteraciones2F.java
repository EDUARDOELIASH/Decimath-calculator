...
public class Iteraciones2F {
    ...
    protected double[][] convertirAUno(double[][] matriz, int totalVar, int c, int f){
    ...
    protected double[][] convertirACero(double[][] matriz, int nrest, int totalVar, int c, int f){
